---
id: vercel-web-analytics-getting-started
title: Getting started with Vercel Web Analytics
slug: /guides/vercel-web-analytics
description: A guide to get started with using Vercel Web Analytics on your project, showing you how to enable it, add the package to your project, deploy your app to Vercel, and view your data in the dashboard.
---
...
```tsx {2, 10} title="src/layouts/Base.astro"
---
